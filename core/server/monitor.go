...
func printStats() {
	...
	if domainData.Stage == 0 && proxy.WatchedDomain != "debug" {
		...
		fmt.Println("")
		fmt.Println("[" + utils.PrimaryColor("+") + "] [ " + utils.PrimaryColor("help") + " ]: " + utils.PrimaryColor("Displays all available commands. More detailed information can be found at ") + "https://github.com/h1v9/balooProxyX#commands")
